    ...
    <div className="flex flex-col min-h-screen bg-[#050505] text-white">
      ...
      <main className="flex-1 w-full">
        ...
        <HeroWithScroll 
          title="How AI-Powered Clinical Decision Support Is Transforming Healthcare in Africa"
          description={
            <div className="flex items-center justify-between w-full text-zinc-400 text-sm mt-12 max-w-[800px] mx-auto">
        ...
        >
          <div className="w-full aspect-video md:aspect-21/9 rounded-2xl overflow-hidden shadow-2xl">
            <img 
        ...
        {/* Article Content */}
        <div className="max-w-[800px] mx-auto px-6 text-zinc-300 text-lg md:text-xl leading-relaxed space-y-16 mb-32 font-light">
          
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-white tracking-tight mb-8">The Problem Is Not Just a Lack of Resources</h2>
            <p>
            ...
            <p>
              This is not a technology problem. It is a systems problem — and systems problems require systems thinking. That is the foundation on which we built UDS, the Ubuntu Digital System.
            </p>
          </div>

          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-white tracking-tight mb-8">What Intelligent Clinical Infrastructure Actually Looks Like</h2>
            <p>
              UDS is not an electronic health record in the traditional sense. It is a clinical intelligence platform — designed from the ground up for the realities of East African healthcare. It works offline. Because connectivity in district hospitals is unreliable, we built UDS to function fully without an internet connection, syncing intelligently when connectivity is restored.
            </p>
            <p>
              It is fast. A nurse at a facility in rural Rwanda can pull up a patient's complete medical history in under three seconds. It is built for decision support. UDS does not just store data — it surfaces insights. When a clinician enters a patient's symptoms and vitals, the system flags potential diagnoses, drug interactions, and care protocols based on clinical evidence.
            </p>
            <p>
              The result is not just efficiency. It is accuracy. And in healthcare, accuracy saves lives.
            </p>
          </div>

          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-white tracking-tight mb-8">The Numbers That Matter</h2>
            <p>
              Since deploying UDS across 15 healthcare facilities in Rwanda, we have observed measurable improvements in clinical workflow speed, a reduction in medication errors, and a significant decrease in the time clinicians spend on administrative tasks versus direct patient care.
            </p>
            <p>
              These are not abstract improvements. Every minute a nurse saves on paperwork is a minute spent with a patient. Every flagged drug interaction is a potential adverse event avoided. Every digitized record is a piece of continuity of care that would otherwise be lost.
            </p>
            <p>
              UDS is one piece of a larger vision. Through NEXUN Inc., our AI research company, we are developing the next generation of clinical intelligence tools — models trained on African patient data, diagnostic support systems designed for high-burden diseases on the continent, and automation that can extend the effective capacity of every clinician without replacing their judgment.
            </p>
            <p>
              The goal is not to build technology that replaces the human at the center of care. The goal is to build technology that gives that human the information, the speed, and the support they need to do their job at the highest possible level. Africa deserves a healthcare system that works. We are building the infrastructure to make that possible.
            </p>
          </div>

          <div className="pt-8">
            <p className="font-medium text-white">— Patrick Ngoga</p>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 mb-24">
          <div className="w-full flex justify-end">
            <Link href="/blog">
              <div className="inline-flex items-center gap-4 px-6 py-3 border border-zinc-800 rounded-full text-zinc-400 hover:text-white hover:border-zinc-700 transition-colors cursor-pointer group">
                <span className="text-sm font-medium">Read other Blogs</span>
